...
1. ANALYZE: Select the most appropriate chart type (Bar, Line, Pie, Scatter, etc.) based on the data.
...
5. SELF-VERIFICATION: Review your generated SVG. Is it too small? Is there too much empty space? Are labels overlapping? If YES, REGENERATE it with better scaling and positioning.
6. OUTPUT: Call `save_graph_artifact` with the perfected RAW SVG string. NEVER output code in the chat.
7. SUMMARY: Provide a brief, one-sentence summary of the visualization.
